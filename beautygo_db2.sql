...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2025 at 07:32 PM
...
(1, 1, 1, 2, '2025-10-26 07:09:14', '2025-01-20 10:00:00', NULL, 'completed', 'Client prefers warm tones'),
(2, 2, 5, 13, '2025-10-26 07:09:14', '2025-01-18 14:30:00', NULL, 'confirmed', 'First time customer'),
(3, 3, 3, 7, '2025-10-26 07:09:14', '2025-01-19 11:00:00', NULL, 'confirmed', 'Lower back pain'),
(4, 1, 4, 11, '2025-10-26 07:09:14', '2025-01-22 15:00:00', NULL, 'confirmed', NULL),
(5, 2, 2, 6, '2025-10-26 07:09:14', '2025-01-21 09:00:00', NULL, 'completed', NULL),
(6, 1, NULL, 12, '2025-11-16 13:39:29', '2025-11-19 11:00:00', NULL, 'cancelled', ''),
(7, 1, NULL, 6, '2025-11-18 11:56:13', '2025-11-21 12:00:00', NULL, 'pending', ''),
(8, 1, NULL, 6, '2025-11-18 13:26:31', '2025-11-19 11:00:00', NULL, 'pending', ''),
(9, 1, NULL, 18, '2025-11-19 04:29:33', '2025-11-26 14:00:00', NULL, 'cancelled', 'utvuybu'),
(10, 1, 6, 18, '2025-11-20 09:59:54', '2025-11-21 15:00:00', NULL, 'cancelled', 'hiubi');
...
(2, 'Tranquil Day Spa', 'Spa & Wellness', 'Relaxing spa treatments including massage, facials, and body treatments.', '09773656712', 'tranquil.spa@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Brgy. Calayo, Nasugbu', '07:00:00', '08:00:00', 'Nasugbu', 0x000000000101000000713d0ad7a3285e40be9f1a2fdd242c40),
...
(4, 'Clarence', 'barbershop', 'to all in need', '0998765432', 'clarence@gmail.com', '$2y$10$Enp/Q5fKyg.845J7vZ3wIuhlMCZ/mT4A.1ZjRHwdya8Dy1CX4GH4C', 'nasugbu st., nasugbu brgy.', '00:00:00', '00:00:00', 'Nasugbu', 0x0000000001010000002a3a92cb7f285e40f90fe9b7af232c40);
...
(4, 'red', 'q', 'blue', '09876543211', 'email@email.com', '$2y$10$36B/FaCsAjru4S/hDb7guutqbH3yD9ESJDID7gGGaAYqnhdIMB18W', 'street in nasugbu, brgy in nasugbu', '2025-11-11 05:47:11', NULL);
...
CREATE TABLE `favorites` (
  ...
  `is_new` tinyint(1) DEFAULT 1 COMMENT '1 = new/unseen, 0 = seen'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `favorites` (`favorite_id`, `customer_id`, `business_id`, `created_at`, `is_new`) VALUES
(1, 2, 3, '2025-11-11 08:48:41', 1);
...
INSERT INTO `notifications` (`notif_id`, `business_id`, `customer_id`, `notif_title`, `notif_text`, `read_status`, `notif_creation`) VALUES
(1, 2, 1, 'New Booking Request', 'Maria Santos has booked an appointment for November 19, 2025 11:00 AM. Please review and confirm.', 0, '2025-11-16 13:39:29'),
(2, 2, 1, 'Appointment Confirmed', 'Your appointment has been confirmed! We look forward to seeing you.', 1, '2025-11-16 13:40:53'),
(3, 1, 1, 'New Booking Request', 'Maria Santos has booked an appointment for November 21, 2025 12:00 PM. Please review and confirm.', 0, '2025-11-18 11:56:13'),
(4, 1, 1, 'New Booking Request', 'Maria Santos has booked an appointment for November 19, 2025 11:00 AM. Please review and confirm.', 0, '2025-11-18 13:26:31'),
(5, 1, 2, 'Appointment Completed', 'Thank you for visiting us! We hope you enjoyed your service.', 0, '2025-11-18 13:30:20'),
(6, 1, 1, 'Appointment Completed', 'Thank you for visiting us! We hope you enjoyed your service.', 0, '2025-11-18 13:30:24'),
(7, 3, 1, 'New Booking Request', 'Maria Santos has booked an appointment for November 26, 2025 2:00 PM. Please review and confirm.', 0, '2025-11-19 04:29:33'),
(8, 3, 2, 'Appointment Confirmed', 'Your appointment has been confirmed! We look forward to seeing you.', 0, '2025-11-19 04:32:01'),
(9, 3, 1, 'New Booking Request', 'Maria Santos has booked an appointment for November 21, 2025 3:00 PM. Please review and confirm.', 0, '2025-11-20 09:59:54');
