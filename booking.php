...
require_once 'backend/function_utilities.php';      // for isCustomerLoggedIn(), getCurrentCustomer(), sanitize()
require_once 'backend/function_customers.php';      // for getCurrentCustomer() -> getCustomerById()
require_once 'backend/function_businesses.php';     // for getBusinessById()
require_once 'backend/function_services.php';       // for getBusinessServices(), getServiceById()
